...
public interface MainService {
	...
	List<CategoryVO> navCategory() throws Exception;//분류전체가져와
	
	ProductVO selectByProductNo(int productNo) throws Exception;//상세페이지에서 쓸거 번호로검색
	
	//List<ProductVO> listCriteria(Criteria cri) throws Exception;
	...
	void updateCartListPlus(String id, int productNo, int productQuantity);// 있는물건 수량 업데이트!+하는거
